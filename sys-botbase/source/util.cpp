...
HidNpadButton parseStringToButton(char* arg)
{
    ...
    {
        return static_cast<HidNpadButton>(HiddbgNpadButton_Home);
    }
    else if (strcmp(arg, "CAPTURE") == 0)
    {
        return static_cast<HidNpadButton>(HiddbgNpadButton_Capture);
    }
    ...
    {
        return static_cast<HidNpadButton>(BIT(20));
    }
